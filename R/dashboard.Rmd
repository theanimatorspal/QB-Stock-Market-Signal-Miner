...
div(style = "display: flex; justify-content: flex-end; align-items: right; gap: 10px; margin-bottom: 10px; height: 40px;",
  ...
  actionButton("top_action", "⛏️ Mine From Top"),
  fileInput("portfolio_file", NULL, buttonLabel = "📂 Upload CSV", accept = ".csv"),
...
observeEvent(input$portfolio_analysis,  {
  print(ksai.portfolio.optimize(input$portfolio_file, input$portfolio_stock_exchange))
})
```
